...
public class ICMainExecutorSerialWithDatum extends ICBaseSlaveSerial {
	
	private static ICMainExecutorSerialWithDatum icMainExe = null;
	...
	public ICMainExecutorSerialWithDatum(int nodeId) {
		this.nodeId = nodeId;
...
//		}
	...
	public static void main(String[] args) {
		...
		icMainExe = new ICMainExecutorSerialWithDatum(nodeID);
