...
public class TestParallelSynchronousIC {
	...
	private class TestNode extends AbstractTestNode implements Application {
		...
		public String[] getGroups() {
			return new String[] {GlobalVariables.ICWORKERS_GROUP};
		};
		...
		public void init() {
			for(int i = 0; i < TOTAL_EXECUTIONS; ++i) {
				SynchronousIC synchronousIC = new SynchronousIC(String.valueOf(i), broadcastModule, resultProcessor);
				activeSynchronousICs.put(String.valueOf(i), synchronousIC);
