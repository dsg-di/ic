...
public class TestReliableBroadcastWithAuthenticators {
	...
	private class TestNode extends AbstractTestNode implements Application {
		private IBroadcast relBroadcast = new ReliableBroadcastWithSignatures(new MacCryptographyModule());
		...
		public void process(Message msg) {
			...
			if((++counter) == (TOTAL_EXECUTIONS * TestReliableBroadcastWithAuthenticators.this.numNodes))
